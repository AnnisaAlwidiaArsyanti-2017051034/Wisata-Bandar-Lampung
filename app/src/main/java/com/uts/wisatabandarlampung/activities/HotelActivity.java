...
import com.uts.wisatabandarlampung.adapter.HotelAdapter;
import com.uts.wisatabandarlampung.api.Api;
import com.uts.wisatabandarlampung.model.ModelHotel;
...
public class HotelActivity extends AppCompatActivity implements HotelAdapter.onSelectData {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tbHotel.setTitle("Daftar Hotel Bandar Lampung");
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for (int i = 0; i < playerArray.length(); i++) {
                                ...
                                dataApi.setIdHotel(temp.getString("id"));
