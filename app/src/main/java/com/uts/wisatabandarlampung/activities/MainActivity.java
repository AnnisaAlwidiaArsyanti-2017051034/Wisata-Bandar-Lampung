...
import com.uts.wisatabandarlampung.adapter.MainAdapter;
import com.uts.wisatabandarlampung.decoration.LayoutMarginDecoration;
import com.uts.wisatabandarlampung.model.ModelMain;
import com.uts.wisatabandarlampung.utils.Tools;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    private void setMenu() {
        ...
        mdlMainMenu = new ModelMain("Kuliner", R.drawable.ic_culinary);
        lsMainMenu.add(mdlMainMenu);
